...
const API_URL = 'https://opentdb.com/api.php?amount=10&category=31&difficulty=medium&type=multiple';
...
export const fetchQuestions = async () => {
  ...
  while (attempt < MAX_RETRIES) {
    try {
      ...
      console.error(`Error fetching questions (attempt ${attempt + 1}/${MAX_RETRIES}):`, error);
      attempt++;
